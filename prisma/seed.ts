...
const products: ProductSeed[] = [
  ...
  {
    slug: "garmin-gpsmap-9022",
    name: "Garmin GPSMAP 9022",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP 9000 Series",
    images: ["/products/garmin-gpsmap-9022-1.png"],
    shortDescription: "Traceur premium 22 pouces, écran tactile 4K, poste de barre professionnel",
    description:
      "Le GPSMAP 9022 est le grand format de la gamme 9000 : écran tactile 4K de 22 pouces, traitement jusqu'à 7 fois plus rapide que les générations précédentes et intégration vidéo HD. Conçu pour les postes de barre professionnels et les unités de pêche hauturière.",
    specs: [
      { label: "Écran", value: "22 pouces tactile, résolution 4K" },
      { label: "Cartographie", value: "Compatible Garmin Navionics+" },
      { label: "Réseau", value: "Garmin BlueNet très haut débit" },
      { label: "Vidéo", value: "Intégration HD (HDCP)" },
    ],
  },
  {
