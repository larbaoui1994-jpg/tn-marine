...
const products: ProductSeed[] = [
  ...
  },
  {
    ...
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP UHD Series 2",
  ...
  {
    slug: "garmin-gpsmap-9013",
    name: "Garmin GPSMAP 9013",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP 9000 Series",
    images: ["/products/garmin-gpsmap-9013-1.png"],
    shortDescription: "Traceur premium 13 pouces, écran tactile 4K, sans sondeur intégré",
    description:
      "Le GPSMAP 9013 ouvre la gamme 9000 avec un écran tactile 4K de 13 pouces et une puissance de traitement nettement supérieure aux générations précédentes. Compatible Garmin Navionics+ et réseau Garmin BlueNet à très haut débit, il peut être complété d'un module sondeur externe.",
    specs: [
      { label: "Écran", value: "13 pouces tactile, résolution 4K" },
      { label: "Cartographie", value: "Compatible Garmin Navionics+" },
      { label: "Réseau", value: "Garmin BlueNet haut débit" },
      { label: "Sondeur", value: "Non intégré, module externe compatible" },
    ],
  },
  {
    slug: "garmin-gpsmap-9010",
    name: "Garmin GPSMAP 9010",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP 9000 Series",
    images: ["/products/garmin-gpsmap-9010-1.png"],
    shortDescription: "Traceur premium 10 pouces, écran tactile HD, sans sondeur intégré",
    description:
      "Le GPSMAP 9010 est le plus compact de la gamme 9000, avec un écran tactile HD de 10 pouces et la même puissance de traitement et le même réseau Garmin BlueNet que le reste de la gamme. Compatible Garmin Navionics+, il peut être complété d'un module sondeur externe.",
    specs: [
      { label: "Écran", value: "10 pouces tactile, résolution HD" },
      { label: "Cartographie", value: "Compatible Garmin Navionics+" },
      { label: "Réseau", value: "Garmin BlueNet haut débit" },
      { label: "Sondeur", value: "Non intégré, module externe compatible" },
    ],
  ...
  {
    slug: "garmin-gpsmap-9017",
    name: "Garmin GPSMAP 9017",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP 9000 Series",
    images: ["/products/garmin-gpsmap-9017-1.png"],
    shortDescription: "Traceur premium 17 pouces, écran tactile 4K, poste de barre professionnel",
    description:
      "Le GPSMAP 9017 offre un très grand écran tactile 4K de 17 pouces avec la puissance de traitement et le réseau Garmin BlueNet de toute la gamme 9000. Conçu pour les postes de barre professionnels et les unités de pêche hauturière.",
    specs: [
      { label: "Écran", value: "17 pouces tactile, résolution 4K" },
      { label: "Cartographie", value: "Compatible Garmin Navionics+" },
      { label: "Réseau", value: "Garmin BlueNet haut débit" },
      { label: "Sondeur", value: "Non intégré, module externe compatible" },
    ],
  ...
  {
    slug: "garmin-gpsmap-1243xsv",
    name: "Garmin GPSMAP 1243xsv",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP X3 Series",
    images: ["/products/garmin-gpsmap-1243xsv-1.png"],
    shortDescription: "Traceur/sondeur combiné 12 pouces, SideVü, ClearVü et CHIRP traditionnel",
    description:
      "Le GPSMAP 1243xsv est le grand format de la gamme X3, avec cartographie Garmin Navionics+ intégrée et sondeur SideVü, ClearVü et CHIRP traditionnel combinés. Compatible avec un kit radar ou un kit voile en complément.",
    specs: [
      { label: "Écran", value: "12 pouces tactile" },
      { label: "Sondeur", value: "SideVü, ClearVü et CHIRP traditionnel" },
      { label: "Cartographie", value: "Garmin Navionics+ intégré" },
      { label: "Options", value: "Kit radar GMR 18 HD3, kit voile" },
    ],
  },
  {
    slug: "garmin-gpsmap-743xsv",
    name: "Garmin GPSMAP 743xsv",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP X3 Series",
    images: ["/products/garmin-gpsmap-743xsv-1.png"],
    shortDescription: "Traceur/sondeur combiné 7 pouces, SideVü, ClearVü et CHIRP traditionnel",
    description:
      "Le GPSMAP 743xsv ouvre la gamme X3 avec un format compact de 7 pouces, la cartographie Garmin Navionics+ intégrée et le sondeur SideVü, ClearVü et CHIRP traditionnel combinés — idéal pour les petites unités.",
    specs: [
  ...
  {
    slug: "garmin-gpsmap-1543xsv",
    name: "Garmin GPSMAP 1543xsv",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP X3 Series",
    images: ["/products/garmin-gpsmap-1543xsv-1.png"],
    shortDescription: "Traceur/sondeur 15 pouces ultra-large, SideVü, ClearVü et CHIRP traditionnel",
    description:
      "Le GPSMAP 1543xsv se distingue par son écran ultra-large de 15 pouces, offrant 74% de surface d'affichage en plus qu'un 9 pouces classique. Cartographie Garmin Navionics+ intégrée et sondeur SideVü, ClearVü et CHIRP traditionnel combinés.",
    specs: [
      { label: "Écran", value: "15 pouces tactile ultra-large" },
      { label: "Sondeur", value: "SideVü, ClearVü et CHIRP traditionnel" },
      { label: "Cartographie", value: "Garmin Navionics+ intégré" },
    ],
  },
  {
    slug: "garmin-gpsmap-1643xsv",
    name: "Garmin GPSMAP 1643xsv",
    brand: "garmin",
    category: "gps-traceurs",
    productLine: "GPSMAP X3 Series",
    images: ["/products/garmin-gpsmap-1643xsv-1.png"],
    shortDescription: "Traceur/sondeur combiné 16 pouces, SideVü, ClearVü et CHIRP traditionnel",
    description:
      "Le GPSMAP 1643xsv est le plus grand modèle de la gamme X3, avec un écran 16 pouces, la cartographie Garmin Navionics+ intégrée et le sondeur SideVü, ClearVü et CHIRP traditionnel combinés. Compatible avec un kit radar ou un kit voile en complément.",
    specs: [
      { label: "Écran", value: "16 pouces tactile" },
      { label: "Sondeur", value: "SideVü, ClearVü et CHIRP traditionnel" },
      { label: "Cartographie", value: "Garmin Navionics+ intégré" },
      { label: "Options", value: "Kit radar GMR 18 HD3, kit voile" },
    ],
  ...
  {
    slug: "garmin-echomap-ultra2-106sv",
    name: "Garmin ECHOMAP Ultra 2 106sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP Ultra 2 Series",
    images: ["/products/garmin-echomap-ultra2-106sv-1.png"],
    shortDescription: "Sondeur/GPS 10 pouces, sondeur UHD intégré, compatible LiveScope",
    description:
      "L'ECHOMAP Ultra 2 106sv associe un écran tactile 10 pouces lisible au soleil, un sondeur UHD scanning et la cartographie Garmin Navionics+ préchargée. Le GPS multibande 10 Hz améliore la précision de position, et l'unité supporte toute la gamme de sondeurs live-scanning LiveScope.",
    specs: [
      { label: "Écran", value: "10 pouces tactile, lisible au soleil" },
      { label: "Sondeur", value: "UHD scanning, compatible LiveScope" },
      { label: "Cartographie", value: "Garmin Navionics+ préchargé" },
      { label: "GPS", value: "Multibande, 10 Hz" },
    ],
  },
  {
    slug: "garmin-echomap-ultra2-126sv",
    name: "Garmin ECHOMAP Ultra 2 126sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP Ultra 2 Series",
    images: ["/products/garmin-echomap-ultra2-126sv-1.png"],
    shortDescription: "Sondeur/GPS 12 pouces, sondeur UHD intégré, compatible LiveScope",
    description:
      "L'ECHOMAP Ultra 2 126sv reprend toutes les fonctions de la 106sv sur un plus grand écran tactile de 12 pouces : sondeur UHD scanning, cartographie Garmin Navionics+ préchargée, GPS multibande et compatibilité complète avec la gamme LiveScope.",
    specs: [
      { label: "Écran", value: "12 pouces tactile, lisible au soleil" },
      { label: "Sondeur", value: "UHD scanning, compatible LiveScope" },
      { label: "Cartographie", value: "Garmin Navionics+ préchargé" },
      { label: "GPS", value: "Multibande, 10 Hz" },
    ],
  ...
  {
    slug: "garmin-echomap-ultra2-166sv",
    name: "Garmin ECHOMAP Ultra 2 166sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP Ultra 2 Series",
    images: ["/products/garmin-echomap-ultra2-166sv-1.png"],
    shortDescription: "Sondeur/GPS 16 pouces Full HD, sondeur UHD intégré, compatible LiveScope",
    description:
      "L'ECHOMAP Ultra 2 166sv est le modèle le plus grand de la gamme, avec un écran Full HD de 16 pouces à assistance par touches. Il conserve le sondeur UHD scanning, la cartographie Garmin Navionics+ préchargée et la compatibilité complète avec la gamme LiveScope.",
    specs: [
      { label: "Écran", value: "16 pouces Full HD, assistance par touches" },
      { label: "Sondeur", value: "UHD scanning, compatible LiveScope" },
      { label: "Cartographie", value: "Garmin Navionics+ préchargé" },
      { label: "Connectivité", value: "HDMI, réseau sans fil" },
    ],
  },
  {
    slug: "garmin-echomap-uhd2-92sv",
    name: "Garmin ECHOMAP UHD2 92sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP UHD Series 2",
    images: ["/products/garmin-echomap-uhd2-92sv-1.png"],
    shortDescription: "Sondeur/GPS 9 pouces, écran tactile avec touches, sondeur UHD SideVü/ClearVü",
    description:
      "L'ECHOMAP UHD2 92sv complète la gamme UHD2 avec un écran tactile 9 pouces à assistance par touches, un sondeur UHD SideVü, ClearVü et CHIRP traditionnel, et le partage sans fil avec le moteur électrique Force et les autres traceurs UHD2.",
    specs: [
      { label: "Écran", value: "9 pouces, tactile avec assistance par touches" },
      { label: "Sondeur", value: "UHD SideVü, ClearVü et CHIRP traditionnel" },
      { label: "Connectivité", value: "Partage sans fil, compatible moteur Force" },
    ],
  },
  {
    slug: "garmin-echomap-uhd2-52cv",
    name: "Garmin ECHOMAP UHD2 52cv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP UHD Series 2",
    images: ["/products/garmin-echomap-uhd2-52cv-1.png"],
    shortDescription: "Sondeur/GPS 5 pouces, écran compact, sondeur UHD ClearVü et CHIRP traditionnel",
    description:
      "L'ECHOMAP UHD2 52cv ouvre la gamme UHD2 avec un écran compact de 5 pouces, le sondeur CHIRP traditionnel et ClearVü, et le partage sans fil avec les autres traceurs UHD2 pour les petites embarcations.",
    specs: [
      { label: "Écran", value: "5 pouces" },
      { label: "Sondeur", value: "CHIRP traditionnel et ClearVü" },
      { label: "Connectivité", value: "Partage sans fil Wi-Fi" },
    ],
  },
  {
    slug: "garmin-echomap-uhd2-72cv",
    name: "Garmin ECHOMAP UHD2 72cv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "ECHOMAP UHD Series 2",
    images: ["/products/garmin-echomap-uhd2-72cv-1.png"],
    shortDescription: "Sondeur/GPS 7 pouces, sondeur UHD ClearVü et CHIRP traditionnel",
    description:
      "L'ECHOMAP UHD2 72cv offre un écran 7 pouces plus grand que le 52cv, avec le même sondeur CHIRP traditionnel et ClearVü, la cartographie Garmin Navionics+ et le partage sans fil avec les autres traceurs UHD2.",
    specs: [
      { label: "Écran", value: "7 pouces" },
      { label: "Sondeur", value: "CHIRP traditionnel et ClearVü" },
      { label: "Connectivité", value: "Partage sans fil Wi-Fi" },
    ],
  },
  {
    ...
    brand: "garmin",
    category: "sondeurs",
    productLine: "STRIKER Vivid Series",
    images: ["/products/garmin-striker-vivid-4cv-1.png"],
    shortDescription: "Sondeur/GPS portable 4,3 pouces, sondeur CHIRP et ClearVü",
    description:
      "Le STRIKER Vivid 4cv ouvre la gamme avec un écran 4,3 pouces aux couleurs vives et un sondeur CHIRP traditionnel et ClearVü. Le GPS haute sensibilité permet de marquer des points chauds, tracer des routes et créer des cartes de fond avec Quickdraw Contours.",
    specs: [
      { label: "Écran", value: "4,3 pouces couleur" },
      { label: "Sondeur", value: "CHIRP traditionnel et ClearVü (sonde GT20)" },
      { label: "GPS", value: "Haute sensibilité, Quickdraw Contours" },
      { label: "Étanchéité", value: "IPX7" },
    ],
  },
  {
    ...
    category: "sondeurs",
    productLine: "STRIKER Vivid Series",
    images: ["/products/garmin-striker-vivid-5cv-1.png"],
    shortDescription: "Sondeur/GPS portable 5 pouces, sondeur CHIRP et ClearVü",
    description:
      "Le STRIKER Vivid 5cv offre un plus grand écran 5 pouces avec les mêmes couleurs vives et le même sondeur CHIRP traditionnel et ClearVü que le 4cv, pour un meilleur confort de lecture.",
    specs: [
  ...
  {
    slug: "garmin-striker-vivid-7sv",
    name: "Garmin STRIKER Vivid 7sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "STRIKER Vivid Series",
    images: ["/products/garmin-striker-vivid-7sv-1.png"],
    shortDescription: "Sondeur/GPS 7 pouces, sondeur CHIRP, ClearVü et SideVü",
    description:
      "Le STRIKER Vivid 7sv ajoute le SideVü au CHIRP traditionnel et au ClearVü pour une vue latérale de la structure et du poisson, sur un écran 7 pouces aux couleurs vives. Wi-Fi intégré pour l'application ActiveCaptain.",
    specs: [
      { label: "Écran", value: "7 pouces couleur" },
      { label: "Sondeur", value: "CHIRP, ClearVü et SideVü (sonde GT52HW-TM)" },
      { label: "Connectivité", value: "Wi-Fi, application ActiveCaptain" },
      { label: "Étanchéité", value: "IPX7" },
    ],
  },
  {
    slug: "garmin-striker-vivid-9sv",
    name: "Garmin STRIKER Vivid 9sv",
    brand: "garmin",
    category: "sondeurs",
    productLine: "STRIKER Vivid Series",
    images: ["/products/garmin-striker-vivid-9sv-1.png"],
    shortDescription: "Sondeur/GPS 9 pouces, sondeur CHIRP, ClearVü et SideVü",
    description:
      "Le STRIKER Vivid 9sv est le plus grand modèle de la gamme, avec un écran 9 pouces pour une lecture confortable du CHIRP traditionnel, du ClearVü et du SideVü. Il peut stocker jusqu'à 2 millions d'acres de cartes avec courbes de niveau au pied.",
    specs: [
      { label: "Écran", value: "9 pouces couleur" },
      { label: "Sondeur", value: "CHIRP, ClearVü et SideVü (sonde GT52HW-TM)" },
      { label: "Connectivité", value: "Wi-Fi, application ActiveCaptain" },
      { label: "Étanchéité", value: "IPX7" },
    ],
